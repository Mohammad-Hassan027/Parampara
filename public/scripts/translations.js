...
const PARAMPARA_TRANSLATIONS = {
  en: {
    ...
    total_assets: 'Total Cultural Assets',
    high_risk: 'High Risk Count',
    medium_risk: 'Medium Risk Count',
    low_risk: 'Low Risk Count',
    risk_craft: 'Craft / Tradition',
    risk_details: 'Details',
    risk_status: 'Risk Status',
    active_artisans: 'Active Artisans',
    documentation_records: 'Documentation Records',
    last_documented_activity: 'Last Documented Activity',
    community_engagement_score: 'Community Engagement Score',
    ...
    nav_reputation: 'Contributor Reputation',
    reputation_title: 'Village Contribution Reputation System',
    reputation_subtitle: 'Celebrate our community contributors preserving rural cultural heritage.',
    profile_card_title: 'Contributor Profile',
    reputation_score: 'Reputation Score',
    current_badge: 'Current Badge',
    member_since: 'Member Since',
    contribution_stats: 'Contribution Statistics',
    stories_submitted: 'Stories Submitted',
    photos_uploaded: 'Photos Uploaded',
    cultural_items_documented: 'Cultural Items Documented',
    checkins_completed: 'Village Check-Ins',
    quests_completed: 'Quests Completed',
    total_contributions: 'Total Contributions',
    leaderboard_title: 'Top Contributors Leaderboard',
    leaderboard_rank: 'Rank',
    leaderboard_contributor: 'Contributor',
    leaderboard_score: 'Score',
    leaderboard_badge: 'Badge',
    badge_explorer: 'Heritage Explorer',
    badge_collector: 'Story Collector',
    badge_archivist: 'Cultural Archivist',
    badge_guardian: 'Heritage Guardian',
    nav_timeline: 'Historical Timeline',
    timeline_title: 'Historical Timeline',
    timeline_subtitle: 'Explore the rich history and evolution of rural cultural heritage.',
    time_travel_toggle: 'Enter Time Travel Mode',
    time_travel_exit: 'Exit Time Travel Mode',
    time_travel_mode: 'Time Travel Mode',
    time_travel_active_desc: 'You are now experiencing the cultural environment of the selected era.',
    before_label: 'Before',
    after_label: 'Today',
    ...
    earliest_recorded_event: 'Earliest Recorded Event',
    latest_recorded_event: 'Latest Recorded Event',
    cultural_assets_tracked: 'Cultural Assets Tracked',
    filter_all: 'All Categories',
    filter_crafts: 'Crafts',
    filter_festivals: 'Festivals',
    filter_villages: 'Villages',
    filter_traditions: 'Traditions',
    cultural_evolution: 'Cultural Evolution',
    search_heritage: 'Search Cultural Heritage...',
    compare_historical_state: 'Historical State',
    compare_modern_state: 'Modern State',
    select_era: 'Select Era',
    nav_story_generator: 'AI Story Generator',
    storyGeneratorTitle: 'AI-Powered Cultural Story Generator',
    storyGeneratorSubtitle: 'Transform rural cultural archives into engaging narrative-style stories.',
    select_item: 'Select Cultural Heritage Item',
    select_style: 'Select Storytelling Style',
    btn_generate: 'Generate Story',
    btn_generating: 'Generating Story...',
    style_educational: 'Educational',
    style_children: "Children's Story",
    style_tourist: 'Tourist Guide',
    style_documentary: 'Cultural Documentary',
    ...
    stopNarration: 'Stop',
    stats_label: 'Story Statistics',
    stats_length: 'Story Length',
    stats_reading_time: 'Reading Time',
    stats_references: 'Cultural References',
    stats_style: 'Story Style',
    disclaimer_label: 'AI Disclaimer',
    disclaimer_text: 'AI-generated cultural narrative based on available Parampara records. This story is intended for educational and exploratory purposes and may not represent a verified historical account.',
    words: 'words',
    minutes: 'min',
  },
  ...
  hi: {
    ...
    nav_risk: 'जोखिम डैशबोर्ड',
    risk_title: 'सांस्कृतिक विरासत जोखिम निगरानी डैशबोर्ड',
    risk_subtitle:
      'लुप्त होने के खतरे वाली सांस्कृतिक परंपराओं, शिल्पों और विरासत वस्तुओं की पहचान, गणना और प्रदर्शन करें।',
    total_assets: 'कुल सांस्कृतिक संपत्तियां',
    high_risk: 'उच्च जोखिम संख्या',
    medium_risk: 'मध्यम जोखिम संख्या',
    low_risk: 'कम जोखिम संख्या',
    risk_craft: 'शिल्प / परंपरा',
    risk_details: 'विवरण',
    risk_status: 'जोखिम स्थिति',
    active_artisans: 'सक्रिय कारीगर',
    documentation_records: 'दस्तावेजीकरण रिकॉर्ड',
    last_documented_activity: 'अंतिम प्रलेखित गतिविधि',
    community_engagement_score: 'सामुदायिक जुड़ाव स्कोर',
    ...
    nav_reputation: 'योगदानकर्ता प्रतिष्ठा',
    reputation_title: 'ग्राम योगदान प्रतिष्ठा प्रणाली',
    reputation_subtitle: 'ग्रामीण सांस्कृतिक विरासत को संरक्षित करने वाले हमारे सामुदायिक योगदानकर्ताओं का सम्मान करें।',
    profile_card_title: 'योगदानकर्ता प्रोफ़ाइल',
    reputation_score: 'प्रतिष्ठा स्कोर',
    current_badge: 'वर्तमान बैज',
    member_since: 'सदस्य बने',
    contribution_stats: 'योगदान सांख्यिकी',
    stories_submitted: 'सबमिट की गई कहानियाँ',
    photos_uploaded: 'अपलोड की गई तस्वीरें',
    cultural_items_documented: 'प्रलेखित सांस्कृतिक वस्तुएं',
    checkins_completed: 'गाँव चेक-इन',
    quests_completed: 'पूरे किए गए अभियान',
    total_contributions: 'कुल योगदान',
    leaderboard_title: 'शीर्ष योगदानकर्ता लीडरबोर्ड',
    leaderboard_rank: 'रैंक',
    leaderboard_contributor: 'योगदानकर्ता',
    leaderboard_score: 'स्कोर',
    leaderboard_badge: 'बैज',
    badge_explorer: 'विरासत अन्वेषक',
    badge_collector: 'कहानी संग्राहक',
    badge_archivist: 'सांस्कृतिक संग्रहकर्ता',
    badge_guardian: 'विरासत संरक्षक',
    nav_timeline: 'ऐतिहासिक समयरेखा',
    timeline_title: 'ऐतिहासिक समयरेखा',
    timeline_subtitle: 'ग्रामीण सांस्कृतिक विरासत के समृद्ध इतिहास और विकास का अन्वेषण करें।',
    time_travel_toggle: 'टाइम ट्रैवल मोड सक्रिय करें',
    time_travel_exit: 'टाइम ट्रैवल मोड से बाहर निकलें',
    time_travel_mode: 'टाइम ट्रैवल मोड',
    time_travel_active_desc: 'अब आप चयनित युग के सांस्कृतिक वातावरण का अनुभव कर रहे हैं।',
    before_label: 'पहले',
    after_label: 'आज',
    historical_significance: 'ऐतिहासिक महत्व',
    key_differences: 'मुख्य अंतर',
    milestone: 'मील का पत्थर',
    timeline_stats: 'समयरेखा सांख्यिकी',
    total_historical_events: 'कुल ऐतिहासिक घटनाएं',
    earliest_recorded_event: 'सबसे पुरानी प्रलेखित घटना',
    latest_recorded_event: 'नवीनतम प्रलेखित घटना',
    cultural_assets_tracked: 'ट्रैक की गई सांस्कृतिक संपत्तियां',
    filter_all: 'सभी श्रेणियां',
    filter_crafts: 'शिल्प',
    filter_festivals: 'त्योहार',
    filter_villages: 'गाँव',
    filter_traditions: 'परंपराएं',
    cultural_evolution: 'सांस्कृतिक विकास',
    search_heritage: 'सांस्कृतिक विरासत खोजें...',
    compare_historical_state: 'ऐतिहासिक स्थिति',
    compare_modern_state: 'आधुनिक स्थिति',
    select_era: 'युग चुनें',
    nav_story_generator: 'एआई कहानी जेनरेटर',
    storyGeneratorTitle: 'एआई-संचालित सांस्कृतिक कहानी जेनरेटर',
    storyGeneratorSubtitle: 'ग्रामीण सांस्कृतिक अभिलेखागार को आकर्षक कथा-शैली की कहानियों में बदलें।',
    select_item: 'सांस्कृतिक विरासत आइटम चुनें',
    select_style: 'कथा वाचन शैली चुनें',
    btn_generate: 'कहानी उत्पन्न करें',
    btn_generating: 'कहानी उत्पन्न हो रही है...',
    style_educational: 'शैक्षणिक',
    style_children: 'बच्चों की कहानी',
    style_tourist: 'पर्यटक गाइड',
    style_documentary: 'सांस्कृतिक वृत्तचित्र',
    summary_label: 'लघु सारांश',
    highlights_label: 'मुख्य विशेषताएं',
    playNarration: 'कथा वाचन शुरू करें',
    pauseNarration: 'विराम',
    resumeNarration: 'फिर से शुरू करें',
    stopNarration: 'रोकें',
    stats_label: 'कहानी के आँकड़े',
    stats_length: 'कहानी की लंबाई',
    stats_reading_time: 'पढ़ने का समय',
    stats_references: 'सांस्कृतिक संदर्भ',
    stats_style: 'कहानी की शैली',
    disclaimer_label: 'एआई अस्वीकरण',
    disclaimer_text: 'उपलब्ध परंपरा रिकॉर्ड के आधार पर एआई-जनित सांस्कृतिक कथा। यह कहानी शैक्षणिक और खोजपूर्ण उद्देश्यों के लिए है और यह सत्यापित ऐतिहासिक खाते का प्रतिनिधित्व नहीं कर सकती है।',
    words: 'शब्द',
    minutes: 'मिनट',
  },
  ...
  mr: {
    ...
    nav_risk: 'धोका डॅशबोर्ड',
    risk_title: 'सांस्कृतिक वारसा जोखीम नियंत्रण डॅशबोर्ड',
    risk_subtitle:
      'नष्ट होण्याचा धोका असलेल्या सांस्कृतिक परंपरा, हस्तकला आणि वारसा घटकांची ओळख, गणना आणि प्रदर्शन करा.',
    total_assets: 'एकूण सांस्कृतिक मालमत्ता',
    high_risk: 'उच्च जोखीम संख्या',
    medium_risk: 'मध्यम जोखीम संख्या',
    low_risk: 'कमी जोखीम संख्या',
    risk_craft: 'हस्तकला / परंपरा',
    risk_details: 'तपशील',
    risk_status: 'जोखीम स्थिती',
    active_artisans: 'सक्रिय कारागीर',
    documentation_records: 'दस्तऐवजीकरण रेकॉर्ड',
    last_documented_activity: 'अंतिम दस्तऐवजीकरण क्रिया',
    community_engagement_score: 'सामुदायिक सहभाग गुण',
    high_risk_label: 'उच्च जोखीम',
    medium_risk_label: 'मध्यम जोखीम',
    low_risk_label: 'कमी जोखीम',
    ...
    nav_reputation: 'योगदानकर्ता प्रतिष्ठा',
    reputation_title: 'ग्राम योगदान प्रतिष्ठा प्रणाली',
    reputation_subtitle: 'ग्रामीण सांस्कृतिक वारसा जतन करणाऱ्या आमच्या समुदाय योगदानकर्त्यांचा गौरव करा.',
    profile_card_title: 'योगदानकर्ता प्रोफाइल',
    reputation_score: 'प्रतिष्ठा गुण',
    current_badge: 'सध्याचा बॅज',
    member_since: 'सदस्य बनले',
    contribution_stats: 'योगदान आकडेवारी',
    stories_submitted: 'सादर केलेल्या कथा',
    photos_uploaded: 'अपलोड केलेले फोटो',
    cultural_items_documented: 'नोंदवलेले सांस्कृतिक घटक',
    checkins_completed: 'गाव चेक-इन',
    quests_completed: 'पूर्ण केलेल्या मोहिमा',
    total_contributions: 'एकूण योगदान',
    leaderboard_title: 'शीर्ष योगदानकर्ता लीडरबोर्ड',
    leaderboard_rank: 'क्रमांक',
    leaderboard_contributor: 'योगदानकर्ता',
    leaderboard_score: 'गुण',
    leaderboard_badge: 'बॅज',
    badge_explorer: 'वारसा अन्वेषक',
    badge_collector: 'कथा संग्राहक',
    badge_archivist: 'सांस्कृतिक संग्रहकर्ता',
    badge_guardian: 'वारसा रक्षक',
    nav_timeline: 'ऐतिहासिक टाइमलाईन',
    timeline_title: 'ऐतिहासिक टाइमलाईन',
    timeline_subtitle: 'ग्रामीण सांस्कृतिक वारशाचा समृद्ध इतिहास आणि उत्क्रांती शोधा.',
    time_travel_toggle: 'टाइम ट्रॅव्हल मोड सुरू करा',
    time_travel_exit: 'टाइम ट्रॅव्हल मोडमधून बाहेर पडा',
    time_travel_mode: 'टाइम ट्रॅव्हल मोड',
    time_travel_active_desc: 'तुम्ही आता निवडलेल्या युगातील सांस्कृतिक वातावरणाचा अनुभव घेत आहात.',
    before_label: 'पूर्वी',
    after_label: 'आज',
    historical_significance: 'ऐतिहासिक महत्त्व',
    key_differences: 'मुख्य फरक',
    milestone: 'महत्त्वाचा टप्पा',
    timeline_stats: 'टाइमलाईन आकडेवारी',
    total_historical_events: 'एकूण ऐतिहासिक घटना',
    earliest_recorded_event: 'सर्वात जुनी नोंदवलेली घटना',
    latest_recorded_event: 'नवीनतम नोंदवलेली घटना',
    cultural_assets_tracked: 'ट्रॅक केलेल्या सांस्कृतिक मालमत्ता',
    filter_all: 'सर्व श्रेणी',
    filter_crafts: 'हस्तकला',
    filter_festivals: 'सण',
    filter_villages: 'गावे',
    filter_traditions: 'परंपरा',
    cultural_evolution: 'सांस्कृतिक उत्क्रांती',
    search_heritage: 'सांस्कृतिक वारसा शोधा...',
    compare_historical_state: 'ऐतिहासिक स्थिती',
    compare_modern_state: 'आधुनिक स्थिती',
    select_era: 'युग निवडा',
    nav_story_generator: 'एआय कथा जनरेटर',
    storyGeneratorTitle: 'एआय-संचालित सांस्कृतिक कथा जनरेटर',
    storyGeneratorSubtitle: 'ग्रामीण सांस्कृतिक अभिलेखागारचे आकर्षक कथा-शैलीतील कथांमध्ये रूपांतर करा.',
    select_item: 'सांस्कृतिक वारसा घटक निवडा',
    select_style: 'कथाकथन शैली निवडा',
    btn_generate: 'कथा तयार करा',
    btn_generating: 'कथा तयार होत आहे...',
    style_educational: 'शैक्षणिक',
    style_children: 'मुलांची कथा',
    style_tourist: 'पर्यटक मार्गदर्शक',
    style_documentary: 'सांस्कृतिक माहितीपट',
    summary_label: 'लघु सारांश',
    highlights_label: 'मुख्य वैशिष्ट्ये',
    playNarration: 'कथाकथन ऐका',
    pauseNarration: 'विराम',
    resumeNarration: 'पुन्हा सुरू करा',
    stopNarration: 'थांबवा',
    stats_label: 'कथा आकडेवारी',
    stats_length: 'कथेची लांबी',
    stats_reading_time: 'वाचनाचा वेळ',
    stats_references: 'सांस्कृतिक संदर्भ',
    stats_style: 'कथा शैली',
    disclaimer_label: 'एआय अस्वीकरण',
    disclaimer_text: 'उपलब्ध परंपरा नोंदींवर आधारित एआय-व्युत्पन्न सांस्कृतिक कथा. ही कथा शैक्षणिक आणि संशोधन हेतूंसाठी आहे आणि कदाचित ती सत्यापित ऐतिहासिक वृत्तांत दर्शवत नाही.',
    words: 'शब्द',
    minutes: 'मिनिटे',
  },
};
